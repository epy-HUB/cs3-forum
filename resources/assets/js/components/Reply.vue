    ...
    <div :id="'reply-' + id" class="panel" :class="isBest ? 'panel-success' : 'panel-default'">
        <div class="panel-heading">
            ...
            <div class="panel-footer level" v-if="authorize('owns', reply.thread) || authorize('owns', reply)" >
                <span v-if="authorize('owns', reply)">
                    <button class="btn btn-xs  mr-1" @click="editing = true" >Edit</button>
                    <button class="btn btn-xs btn-danger  mr-1" @click="destroy" >Delete</button>
                </span>
                    <button  v-if="authorize('owns', reply.thread)" class="btn btn-xs btn-success  ml-a" @click="markBestReply" v-show="!isBest" >Best Reply</button>
