...
Route::get('profiles/api/about/{user}', 'Api\AboutController@index');
// Route::post('profiles/api/about/{user}', 'Api\AboutController@create');
Route::patch('profiles/api/about/{user}', 'Api\AboutController@store');
